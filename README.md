...
```
https://raw.githubusercontent.com/ChiakoRh/WSK/main/subs/mihomo/mihomo-ID.yaml
```
...
```
https://raw.githubusercontent.com/ChiakoRh/WSK/main/subs/mihomo/mihomo-IQ.yaml
```
...
<details>
<summary>🟠 لینک‌های clash کامل (39 کشور)</summary>
...
https://raw.githubusercontent.com/ChiakoRh/WSK/main/subs/clash/clash-ID.yaml
https://raw.githubusercontent.com/ChiakoRh/WSK/main/subs/clash/clash-IN.yaml
https://raw.githubusercontent.com/ChiakoRh/WSK/main/subs/clash/clash-IQ.yaml
...
<details>
<summary>🔵 لینک‌های base64 (34 کشور)</summary>
...
https://raw.githubusercontent.com/ChiakoRh/WSK/main/subs/base64/base64-ID.txt
https://raw.githubusercontent.com/ChiakoRh/WSK/main/subs/base64/base64-IN.txt
https://raw.githubusercontent.com/ChiakoRh/WSK/main/subs/base64/base64-IQ.txt
...
<details>
<summary>⚪ لینک‌های raw (34 کشور)</summary>
...
https://raw.githubusercontent.com/ChiakoRh/WSK/main/subs/raw/raw-ID.txt
https://raw.githubusercontent.com/ChiakoRh/WSK/main/subs/raw/raw-IN.txt
https://raw.githubusercontent.com/ChiakoRh/WSK/main/subs/raw/raw-IQ.txt
...
| 🇦🇱 | `AL` | [mihomo-AL.yaml](subs/mihomo/mihomo-AL.yaml) | [clash-AL.yaml](subs/clash/clash-AL.yaml) | [base64-AL.txt](subs/base64/base64-AL.txt) | [raw-AL.txt](subs/raw/raw-AL.txt) | 2 / 2 |
...
| 🇧🇪 | `BE` | [mihomo-BE.yaml](subs/mihomo/mihomo-BE.yaml) | [clash-BE.yaml](subs/clash/clash-BE.yaml) | [base64-BE.txt](subs/base64/base64-BE.txt) | [raw-BE.txt](subs/raw/raw-BE.txt) | 6 / 6 |
...
| 🇧🇷 | `BR` | [mihomo-BR.yaml](subs/mihomo/mihomo-BR.yaml) | [clash-BR.yaml](subs/clash/clash-BR.yaml) | [base64-BR.txt](subs/base64/base64-BR.txt) | [raw-BR.txt](subs/raw/raw-BR.txt) | 2 / 1 |
| 🇨🇦 | `CA` | [mihomo-CA.yaml](subs/mihomo/mihomo-CA.yaml) | [clash-CA.yaml](subs/clash/clash-CA.yaml) | [base64-CA.txt](subs/base64/base64-CA.txt) | [raw-CA.txt](subs/raw/raw-CA.txt) | 5 / 5 |
| 🇨🇭 | `CH` | [mihomo-CH.yaml](subs/mihomo/mihomo-CH.yaml) | [clash-CH.yaml](subs/clash/clash-CH.yaml) | [base64-CH.txt](subs/base64/base64-CH.txt) | [raw-CH.txt](subs/raw/raw-CH.txt) | 16 / 16 |
| 🇨🇿 | `CZ` | [mihomo-CZ.yaml](subs/mihomo/mihomo-CZ.yaml) | [clash-CZ.yaml](subs/clash/clash-CZ.yaml) | — (فقط mihomo) | — | 1 / 0 |
| 🇩🇪 | `DE` | [mihomo-DE.yaml](subs/mihomo/mihomo-DE.yaml) | [clash-DE.yaml](subs/clash/clash-DE.yaml) | [base64-DE.txt](subs/base64/base64-DE.txt) | [raw-DE.txt](subs/raw/raw-DE.txt) | 92 / 88 |
| 🇪🇨 | `EC` | [mihomo-EC.yaml](subs/mihomo/mihomo-EC.yaml) | [clash-EC.yaml](subs/clash/clash-EC.yaml) | — (فقط mihomo) | — | 1 / 0 |
| 🇪🇸 | `ES` | [mihomo-ES.yaml](subs/mihomo/mihomo-ES.yaml) | [clash-ES.yaml](subs/clash/clash-ES.yaml) | [base64-ES.txt](subs/base64/base64-ES.txt) | [raw-ES.txt](subs/raw/raw-ES.txt) | 3 / 2 |
...
| 🇬🇧 | `GB` | [mihomo-GB.yaml](subs/mihomo/mihomo-GB.yaml) | [clash-GB.yaml](subs/clash/clash-GB.yaml) | [base64-GB.txt](subs/base64/base64-GB.txt) | [raw-GB.txt](subs/raw/raw-GB.txt) | 40 / 40 |
...
| 🇮🇩 | `ID` | [mihomo-ID.yaml](subs/mihomo/mihomo-ID.yaml) | [clash-ID.yaml](subs/clash/clash-ID.yaml) | [base64-ID.txt](subs/base64/base64-ID.txt) | [raw-ID.txt](subs/raw/raw-ID.txt) | 1 / 1 |
| 🇮🇳 | `IN` | [mihomo-IN.yaml](subs/mihomo/mihomo-IN.yaml) | [clash-IN.yaml](subs/clash/clash-IN.yaml) | [base64-IN.txt](subs/base64/base64-IN.txt) | [raw-IN.txt](subs/raw/raw-IN.txt) | 3 / 2 |
| 🇮🇶 | `IQ` | [mihomo-IQ.yaml](subs/mihomo/mihomo-IQ.yaml) | [clash-IQ.yaml](subs/clash/clash-IQ.yaml) | [base64-IQ.txt](subs/base64/base64-IQ.txt) | [raw-IQ.txt](subs/raw/raw-IQ.txt) | 1 / 1 |
| 🇮🇹 | `IT` | [mihomo-IT.yaml](subs/mihomo/mihomo-IT.yaml) | [clash-IT.yaml](subs/clash/clash-IT.yaml) | [base64-IT.txt](subs/base64/base64-IT.txt) | [raw-IT.txt](subs/raw/raw-IT.txt) | 8 / 7 |
| 🇯🇵 | `JP` | [mihomo-JP.yaml](subs/mihomo/mihomo-JP.yaml) | [clash-JP.yaml](subs/clash/clash-JP.yaml) | [base64-JP.txt](subs/base64/base64-JP.txt) | [raw-JP.txt](subs/raw/raw-JP.txt) | 92 / 90 |
...
| 🇱🇻 | `LV` | [mihomo-LV.yaml](subs/mihomo/mihomo-LV.yaml) | [clash-LV.yaml](subs/clash/clash-LV.yaml) | [base64-LV.txt](subs/base64/base64-LV.txt) | [raw-LV.txt](subs/raw/raw-LV.txt) | 2 / 1 |
...
| 🇳🇱 | `NL` | [mihomo-NL.yaml](subs/mihomo/mihomo-NL.yaml) | [clash-NL.yaml](subs/clash/clash-NL.yaml) | [base64-NL.txt](subs/base64/base64-NL.txt) | [raw-NL.txt](subs/raw/raw-NL.txt) | 36 / 26 |
| ❓ | `OT` | [mihomo-OT.yaml](subs/mihomo/mihomo-OT.yaml) | [clash-OT.yaml](subs/clash/clash-OT.yaml) | [base64-OT.txt](subs/base64/base64-OT.txt) | [raw-OT.txt](subs/raw/raw-OT.txt) | 3 / 13 |
| 🇵🇱 | `PL` | [mihomo-PL.yaml](subs/mihomo/mihomo-PL.yaml) | [clash-PL.yaml](subs/clash/clash-PL.yaml) | [base64-PL.txt](subs/base64/base64-PL.txt) | [raw-PL.txt](subs/raw/raw-PL.txt) | 4 / 3 |
| 🇵🇸 | `PS` | [mihomo-PS.yaml](subs/mihomo/mihomo-PS.yaml) | [clash-PS.yaml](subs/clash/clash-PS.yaml) | — (فقط mihomo) | — | 1 / 0 |
| 🇷🇴 | `RO` | [mihomo-RO.yaml](subs/mihomo/mihomo-RO.yaml) | [clash-RO.yaml](subs/clash/clash-RO.yaml) | — (فقط mihomo) | — | 7 / 0 |
| 🇷🇸 | `RS` | [mihomo-RS.yaml](subs/mihomo/mihomo-RS.yaml) | [clash-RS.yaml](subs/clash/clash-RS.yaml) | — (فقط mihomo) | — | 1 / 0 |
| 🇷🇺 | `RU` | [mihomo-RU.yaml](subs/mihomo/mihomo-RU.yaml) | [clash-RU.yaml](subs/clash/clash-RU.yaml) | [base64-RU.txt](subs/base64/base64-RU.txt) | [raw-RU.txt](subs/raw/raw-RU.txt) | 2 / 2 |
...
| 🇸🇬 | `SG` | [mihomo-SG.yaml](subs/mihomo/mihomo-SG.yaml) | [clash-SG.yaml](subs/clash/clash-SG.yaml) | [base64-SG.txt](subs/base64/base64-SG.txt) | [raw-SG.txt](subs/raw/raw-SG.txt) | 52 / 51 |
| 🇺🇸 | `US` | [mihomo-US.yaml](subs/mihomo/mihomo-US.yaml) | [clash-US.yaml](subs/clash/clash-US.yaml) | [base64-US.txt](subs/base64/base64-US.txt) | [raw-US.txt](subs/raw/raw-US.txt) | 55 / 38 |
| 🇿🇦 | `ZA` | [mihomo-ZA.yaml](subs/mihomo/mihomo-ZA.yaml) | [clash-ZA.yaml](subs/clash/clash-ZA.yaml) | [base64-ZA.txt](subs/base64/base64-ZA.txt) | [raw-ZA.txt](subs/raw/raw-ZA.txt) | 2 / 1 |
<!-- COUNTRY-TABLE-END -->
